...
},
{
  ...
  "type": "Example",
  "number": "2.4.2",
  "title": "Circulation around semicircle.",
  "body": "Circulation around semicircle \n        Use Green's theorem to Compute  , where   and   is the simple positively oriented curve obtained by joining the line segment from   to   the the upper half of the circle  .\n       \n        Letting  . The curve   bounds the region\n         .\n        Since   is oriented counterclockwise, we apply Green's theorem to conclude\n         .\n\n       "
},
{
  "id": "d_scalar_curl",
  "level": "2",
...
},
{
  ...
  "type": "Example",
  "number": "2.4.5",
  "title": "Area of astroid.",
  "body": "Area of astroid \n        Use   to compute the area of the astroid curve   with parametrization  ,  .\n         \n       \n        Evaluating   at   and  , we see that   traverses   in the counterclockwise direction. While we're at it, we compute:\n         .\n        Applying   to the vector field  , which satisfies  , we compute\n         \n       "
},
{
...
},
{
  ...
  "type": "Example",
  "number": "2.4.10",
  "title": "Flux across square.",
  "body": "Flux across square \n      Compute the outward flux of   across the square bounded by the lines  ,  .\n     \n      Let   be the given square region, and let   be the perimeter of  , oriented counterclockwise. By  , we have\n       .\n     "
},
{
...
},
{
  ...
  "type": "Example",
  "number": "2.4.13",
  "title": "Visualizing curl and divergence.",
  "body": "Visualizing curl and divergence \n      The vector field diagram is provided for each   below. Using our interpretations of curl and divergence, try your best to visually identify points   where   and\/or  . Confirm your answers by computing   and   algebraically. Assume   is a nonzero fixed constant.\n     \n         Uniform expansion\/compression \n         \n           \n         \n       \n         Uniform rotation \n         \n           \n         \n       \n         Shearing flow \n         \n           \n         \n       \n         Whirlpool \n         \n           \n         \n       \n         \n          Algebraically, we have   and  . Can we see this in the diagram?\n         \n         \n             \n              Curl. Put a pinwheel down in the first quadrant. By symmetry about the line connecting the origin to the center of the pinwheel, we see that what ever  counterclockwise  push there is on the lower right section of the pinwheel is matched by a symmetric  clockwise  push on the upper left. Thus total circulation around any small circle is zero, making flux zero. The same argument applies to any quadrant.\n             \n           \n             \n              Divergence. We can at least estimate a positive divergence using flux across a small circle. Place a little circle somewhere in the first quadrant. Since the inward arrows at the bottom left of the dist are beaten out by larger outward arrows at the upper left of the circle, net flux out is positive.\n             \n           \n       \n         \n          Algebraically, we have   and  . Can we see this in the diagram?\n         \n         \n             \n              Curl. We can at least estimate a positive curl using circulation of the pinwheel. Again, place the pinwheel anywhere in the first quadrant. The  coutnerclockwise  push from the arrows at the upper right beat the  clockwise  push from the arrows at the lower left, giving this a positive circulation. Since flux at a point   can be estimated by the circulation around a small circle at  , we can estimate that the flux at any point   is positive.\n             \n           \n             \n              Divergence. Now place a little disk down somewhere. It is clear by the symmetry about the line from the origin to the center of the disk that for each inward arrow there is a matching outward one, flux across the circle zero.\n             \n           \n       \n         \n          Algebraically, we have   and  . Can we see this in the diagram?\n         \n         \n             \n              Curl. We can at least estimate a negative curl at each point in the plane, by looking at the circulation of a little pinwheel. Placing a pinwheel in the first quadrant, for example, we see that the clockwise push at the top beats out the counterclockwise push at the bottom, resulting in a negative circulation.\n             \n           \n             \n              Divergence. This we can see. For any disk placed in the upper half of the plane, for each arrow in at the left of the disk there is an equal arrow out of the disk directly to the right.\n             \n           \n       \n         \n          Algebraically, we have   and  . Can we see this in the diagram? A by now familiar argument easily convinces us that flux across any circle (not centered at the origin) is zero, and hence that divergence is zero everywhere. The fact that curl is zero is harder to see. Indeed, the vector field is very similar in nature to (b), where the scalar curl is positive. This indicates the limitations of our ability to  see  curl in a vector field diagram!\n         \n       "
},
{
  "id": "s_surfaces_area",
  "level": "1",
...
},
{
  ...
  "type": "Example",
  "number": "2.5.15",
  "title": "Surface area of paraboloid.",
  "body": "Surface area of paraboloid \n        Find the surface area of the portion of the paraboloid   that lies below the plane  .\n       \n           \n            First parametrize, using cylindrical coordinates:\n             .\n            Here the region   is a polar description of the projection of   on the  -plane, obtained by first observing that the intersection of the paraboloid with the plane   is given by  , or  .\n           \n         \n           \n            Now assemble ingredients:\n             .\n           \n         \n           \n            Finally, we integrate\n             .\n           \n         \n      Note: we could have used the more straightforward parametrization  , noticing that   expresses   as a function of   and   (see  ). Interestingly, the integral in (3) for this choice of parametrization is best computed using a polar coordinates change of variable.\n     "
},
{
...
{
  "id": "sage_surface_integral_vector",
  "level": "2",
  "url": "s_surfaces_integrals.html#sage_surface_integral_vector",
  "type": "Sage example",
  "number": "2.6.2",
  "title": "Surface integrals of vector fields.",
  "body": "Surface integrals of vector fields \n    The Sage cell below assembles the many necessary ingredients to compute a surface integral of a vector field  , then returns the value of the integral, as well as a diagram of the surface, some normal vectors (in green), and the vector field. You can use this to check your surface integral computations by adjusting the parametrization  r(u,v)  and its parameter domain description. You may also want to adjust the domain specified for the vector field plot  Field . \n   "
},
{
  "id": "s_Stokes",
  "level": "1",
...
},
{
  ...
  "type": "Example",
  "number": "2.7.5",
  "title": "Stokes for a pringle.",
  "body": "Stokes for a pringle \n          Let   be a portion of the surface   lying within the cylinder  , and let   be its boundary. Let   be the upward orientation on  . Verify Stokes's theorem for  , and the vector field  .\n         \n          I include this mainly as a nice parametrization example. The surface is parametrized using cylindrical coordinates as\n           ,\n          and the boundary curve   with counterclockwise orientation has parametrization\n           .\n          (Evaluate Sage cell below for a visualization.)\n          Next compute\n           .\n          Since the  -component of   is  , we see that it gives rise to the given choice of  upward  orientation. With all the ingredients assembled, I leave it to you to verify that\n           .\n         "
},
{
...
},
{
  ...
  "type": "Example",
  "number": "2.7.7",
  "title": "Stokes for sliced cylinder.",
  "body": "Stokes for sliced cylinder \n        Let  , and let   be the intersection of the cylinder   and the plane  . Compute  , where   is oriented counterclockwise, viewed from above.\n       Solution 1 \n        The curve   is the boundary of the elliptical region   it encloses in the plane  . Since   for points on this plane, we can parametrize as\n         .\n        Assembling ingredients we have\n         .\n        Since the  -component of   is nonnegative, we see that this gives rise to the  upward  orientation on  , which induces the counterclockwise orientation on  . We can now use Stokes's theorem to concude\n         \n       Solution 2 \n      Alternatively, we can treat   as the boundary of the piecewise smooth surface  , where   is the portion of the cylinder   above the  -plane and below the plane  , and   is the disc   in the  -plane. To have the given orientation of   be induced by that of  , we must choose the  inward  orientation   on  \n      : this orientation is  inward  on the cylinder   and  upward  on the disc  . With this setup we have\n       .\n      A few comments are in order. We have   because the normal vectors to the cylinder   point horizontally, and thus are orthogonal to the curl vectors  , which point vertically. Secondly, on the disc in the  -plane we clearly have the upward normal vector equal to  .\n       "
},
{
  "id": "example-66",
  "level": "2",
  ...
  "type": "Example",
  "number": "2.7.8",
  "title": "Stokes's implies Green's.",
  "body": "Stokes's implies Green's \n        Show that Stokes's theorem implies Green's theorem.\n       \n        Let   be the region enclosed by a simple, piecewise smooth planar curve   oriented counterclockwise, and suppose   satisfies the conditions of  . Define  , and think of   as a planar surface living in the  -plane, with   is boundary. We choose the orientation   on  , which induces the counterclockwise orientation on  . By Stokes's theorem we have\n         .\n       "
},
{
...
},
{
  "id": "proof-16",
  "level": "2",
  "url": "s_Divergence.html#proof-16",
  "type": "Proof",
  "number": "2.8.1",
  "title": "",
  "body": "\n        For all   let   be the solid ball of radius   centered at  . We have   and so by the divergence theorem\n         .\n        Next a generalization of the integral average value theorem to triple integrals imlies\n         \n        for some point   in the ball   centered around  . Since   is continuous at   we have\n         .\n\n\n       "
